...
document.getElementById('btn').addEventListener('click', function () {
    ...
    if (guess === randomNumber) {
        BoxCount++; // Increment BoxCount here
        lock.src = 'treasure opened.jpg';
        ...
        setTimeout(() => {
            lock.src = 'treasureclosed.jpg';
            display("Guess the number to open the box " + (BoxCount + 1)); // Use BoxCount + 1 for the next iteration
